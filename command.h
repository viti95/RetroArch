...
enum event_command
{
   ...
   /* CORRUPTELLA */
   CMD_EVENT_CORRUPTELLA_FUCK_RAM,
   CMD_EVENT_CORRUPTELLA_FUCK_ROM,
   CMD_EVENT_CORRUPTELLA_FUCK_SOUND,
   CMD_EVENT_CORRUPTELLA_FUCK_MUSIC,
   CMD_EVENT_CORRUPTELLA_FUCK_VIDEO
};
