...
const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
      ...
      DECLARE_META_BIND(2, corruptella_fuck_ram,    CORRUPTELLA_FUCK_RAM,      MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_RAM),
      DECLARE_META_BIND(2, corruptella_fuck_rom,    CORRUPTELLA_FUCK_ROM,      MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_ROM),
      DECLARE_META_BIND(2, corruptella_fuck_sound,  CORRUPTELLA_FUCK_SOUND,    MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_SOUND),
      DECLARE_META_BIND(2, corruptella_fuck_music,  CORRUPTELLA_FUCK_MUSIC,    MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_MUSIC),
      DECLARE_META_BIND(2, corruptella_fuck_video,  CORRUPTELLA_FUCK_VIDEO,    MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_VIDEO),
#ifdef HAVE_MENU
