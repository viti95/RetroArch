...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_RAM,
   MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_ROM,
   MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_SOUND,
   MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_MUSIC,
   MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_VIDEO,
