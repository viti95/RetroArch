...
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_RAM,
   "CORRUPTELLA -> RAM")
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_ROM,
   "CORRUPTELLA -> ROM")
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_SOUND,
   "CORRUPTELLA -> Sound")
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_MUSIC,
   "CORRUPTELLA -> Music")
MSG_HASH(MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_VIDEO,
   "CORRUPTELLA -> Video")
