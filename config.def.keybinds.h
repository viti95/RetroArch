...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   { true, CORRUPTELLA_FUCK_RAM,          MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_RAM,       RETROK_UNKNOWN, NO_BTN, NO_BTN, 0, AXIS_NONE },
   { true, CORRUPTELLA_FUCK_ROM,          MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_ROM,       RETROK_UNKNOWN, NO_BTN, NO_BTN, 0, AXIS_NONE },
   { true, CORRUPTELLA_FUCK_SOUND,        MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_SOUND,     RETROK_UNKNOWN, NO_BTN, NO_BTN, 0, AXIS_NONE },
   { true, CORRUPTELLA_FUCK_MUSIC,        MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_MUSIC,     RETROK_UNKNOWN, NO_BTN, NO_BTN, 0, AXIS_NONE },
   { true, CORRUPTELLA_FUCK_VIDEO,        MENU_ENUM_LABEL_VALUE_INPUT_CORRUPTELLA_FUCK_VIDEO,     RETROK_UNKNOWN, NO_BTN, NO_BTN, 0, AXIS_NONE },
